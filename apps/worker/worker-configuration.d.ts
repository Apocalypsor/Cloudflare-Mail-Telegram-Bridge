/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3166657f6e2f01c57aadd00d2d601fe0)
// Runtime types generated with workerd@1.20260722.1 2026-04-21 nodejs_compat
interface __BaseEnv_Env {
	...
	TELEGRAM_RATE_LIMITER: DurableObjectNamespace<import("./src/index").TelegramRateLimiter>;
	OBS_SERVICE: Fetcher /* workers-observability-hub */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TelegramRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_NAME" | "ADMIN_SECRET" | "ADMIN_TELEGRAM_ID">> {}
}
